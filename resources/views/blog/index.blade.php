      ...
      <div class="row d-flex">
        <div class="col-md-4 d-flex ftco-animate">
          <div class="blog-entry align-self-stretch">
            <a href="blog-single.html" class="block-20 rounded" style="background-image: url('images/event-1.jpg');">
            </a>
            <div class="text mt-3">
                <div class="meta mb-2">
                <div><a >Dec. 25, 2019</a></div>
                <div><a >Admin</a></div>
                <div><a class="meta-chat"><span class="icon-chat"></span> 3</a></div>
              </div>
              <h3 class="heading"><a href="blog-single.html">Christmas Lunch Buffet</a></h3>
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
              <a href="blog-single.html" class="btn btn-secondary rounded">More info</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 d-flex ftco-animate">
